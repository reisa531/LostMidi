...
export function AdminUnavailable() {
  return <div role="status" className="rounded-xl border border-amber-200 bg-amber-50 p-6 text-sm leading-7"><h2 className="font-semibold text-amber-950">暂时无法读取档案数据</h2><p className="text-amber-900">请稍后刷新页面重试。若问题持续，请联系站点维护者。</p><Link className="archive-link mt-2 inline-block" href="/admin">返回工作台</Link></div>;
}
